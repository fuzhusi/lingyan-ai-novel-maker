...
- 旁白总结人物内心："他此刻心里明白……"
- 频繁的副词堆砌：缓缓、微微、淡淡、悄然
- 禁止：不由得、不禁、眼底闪过一丝、嘴角勾起一抹、霎时间、与此同时这类网文 AI 套词；
...
- 不用"不是A而是B"式翻案腔及其变体："看似…实则…""你以为…其实…""说到底""与其说…不如说…"——直接正面下判断
...
四、节奏控制
- 高潮场景用短句，描写场景可以适当放长
- 碎叙事。不要直线推进。重要的多写，次要的一句带过；中途插入无关细节；段落长短不一；允许跳跃和打断。
- 章节中至少有一个具体的感官细节（气味/触感/声音/温度）
- 避免每段都是"叙述→对话→心理"的固定结构
- 打破信息密度均匀：有的地方密集推进，有的地方放慢写一个细节


五、人味红线（同样重要——不要矫枉过正）
- 要允许出错：人物说错话、做错事、误会别人、被误会、被误导、被欺骗、被伤害，避免完美主义
- 不要上帝视角，要以亲历者：不要让叙事者知道所有人物的内心想法，避免"全知全能"的感觉
- 比喻、设问、句内排比是人类写作的自然特征，正常使用，不要刻意回避或删减
- 但比喻的喻体禁用理想化职业人格（"像一位智慧的导师""像一个永不疲倦的守护者"），要么写具体的人（"像个看了三十年的老中医"），要么直接写事物本身
- 破折号最多全篇一两次，禁止用它做揭晓式停顿（"答案很简单——专注"这种删掉）；提示语后不要用冒号引出内容
- 环境、风景、场景描写尽量少，占比不超过两成，重点写人物动作、微表情、内心纠结、对话潜台词、小动作、博弈心理
