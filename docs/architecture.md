...
**灵砚 (LingYan)** — AI 小说创作系统。支持长篇和短篇创作，多 Agent 协作，17 维度质量审计，按 Agent 类型配置模型，**单用户免登录**。
...
| Agent 组 | 维度数 | 维度 |
|----------|--------|------|
| 角色 (Character) | 4 | 性格一致性、行为合理性、对话自然度、成长轨迹 |
| 剧情 (Plot) | 4 | 逻辑连贯性、节奏把控、冲突推进、悬念管理 |
| 世界观 (World) | 3 | 世界观一致性、战力平衡、时间线正确性 |
| 文笔 (Writing) | 4 | 文笔流畅度、感官描写、AI痕迹、信息密度 |
| 伏笔 (Foreshadow) | 2 | 伏笔推进、伏笔回收 |
| **总计** | **17** | 6 个并行审计 Agent |
